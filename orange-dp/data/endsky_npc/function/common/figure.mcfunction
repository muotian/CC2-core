...
execute anchored eyes facing entity @a[limit=1,tag=npc.user] eyes on passengers positioned as @s run rotate @s[type=minecraft:marker] ~ ~
execute anchored eyes on passengers rotated as @s[type=minecraft:marker] on vehicle positioned ^ ^ ^5 rotated as @s positioned ^ ^ ^20 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run rotate @s ~ ~
