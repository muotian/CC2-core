...
execute if data storage endsky_npc:common Condition{Type:"item"} unless data storage endsky_npc:common Condition.Value.tests run function endsky_npc:common/option/condition/item with storage endsky_npc:common Condition.Value
execute if data storage endsky_npc:common Condition{Type:"item"} if data storage endsky_npc:common Condition.Value.tests run function endsky_npc:common/option/condition/item_tests with storage endsky_npc:common Condition.Value
