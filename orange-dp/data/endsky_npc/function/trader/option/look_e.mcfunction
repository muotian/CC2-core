...
data modify entity @e[limit=1,type=minecraft:text_display,tag=npc.trader_d,tag=npc.this] text set value '{"color":"black","translate":"npc.orange.common.talk"}'
data modify entity @e[limit=1,type=minecraft:text_display,tag=npc.trader_e,tag=npc.this] text set value '{"color":"black","text":"> ","extra":[{"translate":"npc.orange.common.exit"}]}'
