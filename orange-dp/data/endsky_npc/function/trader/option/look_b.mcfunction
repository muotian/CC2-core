...
data modify entity @e[limit=1,type=minecraft:text_display,tag=npc.trader_b,tag=npc.this] text set value '{"color":"black","text":"> ","extra":[{"translate":"npc.orange.common.buy"}]}'
