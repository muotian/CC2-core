...
data modify entity @e[limit=1,type=minecraft:text_display,tag=npc.trader_s,tag=npc.this] text set value '{"color":"black","text":"> ","extra":[{"translate":"npc.orange.common.sell"}]}'
