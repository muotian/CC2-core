...
execute on vehicle at @s run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:structure_void",count:1,components:{"minecraft:item_model":"minecraft:air"}},PickupDelay:32767,Age:5940,Tags:["orange.time_stealing_potion.vehicle"]}
