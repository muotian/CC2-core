execute unless data entity @s {HurtTime:0s} run return run function orange:mob/speedy_glider/fail
execute on target run tag @s add orange.mob.target
rotate @s facing entity @e[limit=1,tag=orange.mob.target,distance=..100]
