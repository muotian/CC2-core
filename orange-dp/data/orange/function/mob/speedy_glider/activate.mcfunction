...
item modify entity @s armor.head [{function:"minecraft:set_components",components:{"minecraft:glider":{}}},{function:"minecraft:set_enchantments",enchantments:{"orange:mob/falling":1,"orange:mob/post_attack":1}}]
