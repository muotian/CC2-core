execute unless score @s orange.time_stealing.level matches 1.. run scoreboard players remove @s orange.time_stealing.level 1
execute if score @s orange.time_stealing.level matches 1.. run scoreboard players remove @s orange.time_stealing.level 2
