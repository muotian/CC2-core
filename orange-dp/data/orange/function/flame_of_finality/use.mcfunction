...
title @s[scores={orange.flame_of_finality.effect=5}] subtitle [{"text":"✡✡✡✡✡","color":"dark_red"},{"text":"✡✡✡✡✡","color":"dark_gray"}]
title @s[scores={orange.flame_of_finality.effect=6}] subtitle [{"text":"✡✡✡✡✡✡","color":"dark_red"},{"text":"✡✡✡✡","color":"dark_gray"}]
title @s[scores={orange.flame_of_finality.effect=7}] subtitle [{"text":"✡✡✡✡✡✡✡","color":"dark_red"},{"text":"✡✡✡","color":"dark_gray"}]
title @s[scores={orange.flame_of_finality.effect=8}] subtitle [{"text":"✡✡✡✡✡✡✡✡","color":"dark_red"},{"text":"✡✡","color":"dark_gray"}]
title @s[scores={orange.flame_of_finality.effect=9}] subtitle [{"text":"✡✡✡✡✡✡✡✡✡","color":"dark_red"},{"text":"✡","color":"dark_gray"}]
title @s[scores={orange.flame_of_finality.effect=10}] subtitle [{"text":"✡✡✡✡✡✡✡✡✡✡","color":"dark_red"}]

    # 偵測玩家是否層數大於等於10 / Detect if the player has 10 or more score

    advancement grant @s[scores={orange.flame_of_finality.effect=10..}] only orange:flame_of_finality/effect/true