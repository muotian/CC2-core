...
$item modify entity @s $(slot) [{function:"minecraft:set_custom_model_data",colors:{values:[0],mode:"replace_section",size:1}},{function:"minecraft:set_custom_data",tag:{cooldown:{target:-1,active:0b}}}]
